  ...
  return (
    <section className="mt-28 py-20">
      <header className="space-y-6">
        ...
        <p className="~text-[1.125rem]/[1.375rem] max-w-[50rem] text-grey">
          Natoque nunc sit diam volutpat nulla faucibus risus in pellentesque.
          Sed diam sagittis non arcu. Consectetur enim lobortis.
        </p>
      </header>

      <div className="mt-14 flex size-full max-h-[32.625rem] items-start justify-between gap-8 max-lg:flex-col">
        <figure className="size-full min-h-80 max-w-[50rem] bg-yellow-500"></figure>

        <div className="flex size-full flex-col items-start justify-between gap-8">
          <div className="space-y-10 font-circularStd">
            <div className="~gap-4/6 flex items-center justify-start">
              <div className="size-12 rounded-full bg-primary-500"></div>
              <p className="~text-sm/xl font-medium text-black/70">
                Adefaramade Petunia
              </p>

              <p className="~text-sm/base ml-auto italic text-grey">
                5 mins read
              </p>
            </div>

            <div className="space-y-5">
              <h3 className="~text-2xl/3xl font-bold tracking-[0.05625rem]">
                Success Stories: Real Impact of EazyReach Initiatives
              </h3>

              <p className="~text-base/lg leading-[1.875rem] text-grey">
